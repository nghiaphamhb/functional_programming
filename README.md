...
- **OCaml Lint** — проверка кода с помощью компилятора OCaml (предупреждения, неиспользуемые переменные, несовпадения шаблонов) и форматирование с помощью ocamlformat.
